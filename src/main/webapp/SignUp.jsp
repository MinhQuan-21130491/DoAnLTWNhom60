    ...
    <section class="signup mt-5">
        ...
        <div class="contain">
            <div class="signup-content">
                <form method="POST" id="signup-form" class="signup-form" action="HomePage.html">
                    <h5>ĐĂNG KÍ</h5>
                    <div class="form-SignUp">
                        ...
                        <div class="form-group">
                            <label>Mật khẩu</label><span class="text-danger" id="errPW"></span>
                            <input type="password" class="form-input" placeholder="Nhập mật khẩu" name="password"
                                   id="password"/>
                        </div>
                        <div class="form-group">
                            <label for="re_password">Nhập lại mật khẩu</label><span class="text-danger" id="errRePW"></span>
                            <input type="password" class="form-input" placeholder="Nhập lại mật khẩu" name="re_password"
                                   id="re_password"/>
                        </div>
                    </div>
                    <div class="form-info">
                        ...
                        <div class="form-group">
                            <label>Họ Tên</label><span class="text-danger" id="errName"></span>
                            <input type="text" class="form-input" placeholder="Nhập họ và tên" name="name" id="name"/>
                        </div>

                        <div class="form-group">
                            <label for="phone_number">Số điện thoại</label><span class="text-danger" id="errTell"></span>
                            <input type="text" class="form-input" placeholder="Nhập số điện thoại" name="phone_number"
                                   id="phone_number" inputmode="numeric"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Giới tính</label><span class="text-danger" id="errGender"></span>
                            <div id="gender">
                                <label for="male">Nam</label><input type="radio" id="male" name="gender" value="Nam" class="gender" checked >
                                <label for="female">Nữ</label> <input type="radio" id="female" name="gender" value="Nữ" class="gender">
                                <label for="other">Khác</label> <input type="radio" id="other" name="gender" value="Khác" class="gender">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Ngày sinh</label><span class="text-danger" id="errDate"></span>
                    ...
                    <div class="form-group" >
                        <button type="submit" id="confirm" style="display: none">
                           XÁC NHẬN
                        </button>
                    </div>
                </form>
