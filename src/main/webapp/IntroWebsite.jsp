                        ...
                        <div class="container-fluid px-0">
                            ...
                            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                                ...
                                <div class="col-lg-2  d-lg-block d-md-none d-none ">
                                    <ul class="navbar-nav justify-content-end">
                                        <li class="nav-item hv pe-2"><a class="nav-link" href="#">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-2 col-2 ps-2 d-flex align-items-center">
                            <a class="nav-link" href="#">
                                <button class="position-relative border-0 bg-light "><i class="fa fa-shopping-cart"
                                                                                        aria-hidden="true"
                                                                                        style="font-size: 25px"></i><span
                                        class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">99+<span
                                        class="visually-hidden">unread messages</span></span>
        ...
        <div class="container mt-3 pb-3">
            <div class="row py-3 float-xs-center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 ">
                    ...
                    <hr class="w-50 ">
                    <ul class="navbar-nav ">
                        <a class="nav-link link" href="IntroWebsite.html">
                            <li>Giới thiệu</li>
                        </a>
                        <a class="nav-link link" href="IntroWebsite.html#policy">
                            <li>Bảo hành</li>
                        </a>
                        <a class="nav-link link" href="IntroWebsite.html#policy">
                            <li>Đổi trả</li>
                        </a>
                        <a class="nav-link link" href="IntroWebsite.html#contact">
                            <li>Liên hệ</li>
                        </a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <hr class="w-50 ">
                    <ul class="navbar-nav ">
                        <li class="nav-link"><i class="fa fa-map-marker" aria-hidden="true"></i> 230A Tô Ngọc Vân,
                            Phường Linh Xuân, Thành phố Thủ Đức
                        </li>
                        <li class="nav-link"><i class="fa fa-envelope" aria-hidden="true"></i> homedecorsqn@gmail.com
                        </li>
