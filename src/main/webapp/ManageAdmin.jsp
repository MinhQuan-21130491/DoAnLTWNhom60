...
<div class="container p-0 mgt">
    <a href="<%=url%>/homePage" class="color-gray lbhv text-decoration-none">Trang chủ <i
            class="fa fa-angle-right color-gray" aria-hidden="true"></i> </a> <span class="color-gray"
                                                                                    id="sp">Quản lý</span>
    ...
    <div class="row mt-3">
        ...
        <div class="col-lg-9 bgcolor " id="mngAccount">
            <div class="row mt-2">
                ...
                <div class="col-lg-6 text-end">
                    <button class="btnAdd bgcolor bd-full" id="btnAddAccount"><i class="fa fa-plus-circle text-color"
                                                                                 aria-hidden="true"
                                                                                 title="Thêm sản phẩm"
                        ...
                        <tr data-bs-toggle="modal" data-bs-target="#detailAccount">
                            ...
                            <td>
                                <div class="d-flex w-100 justify-content-center">
                                    <button class="delete btnAdd bgcolor bd-full" aria-hidden="true"
                                            data-bs-toggle="modal" data-bs-target="#"><i
                                            class="fa fa-trash-o text-color" title="Xóa"></i></button>
                                    <button class="block btnAdd bgcolor bd-full mx-1" data-bs-toggle="modal"
                                            data-bs-target="#"><i class="fa fa-lock text-color" title="Khóa"
                                                                  aria-hidden="true"></i></button>
                                    <button class="editAccount btnAdd bgcolor bd-full me-1"
                                            title="Chỉnh sửa quyền truy cập" aria-hidden="true" data-bs-toggle="modal"
                                            data-bs-target="#editAccount"><i class="fa fa-pencil text-color"></i>
                                    </button>
                                </div>
                            </td>
                        </tr>
                            ...
                            <form class="" action="" method="post">
                                <div class="row px-4  pt-0">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <input class="ms-4" type="checkbox" id="staff" name="per"
                                               value="Nhân viên"><label for="staff">Nhân viên</label>
                                    </div>
                                    <div class="row p-0">
            ...
            <div class="modal fade" id="detailAccount" tabindex="-1" aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
        ...
        <div class="col-lg-9 bgcolor d-none " id="mngProduct">
            <div class="row mt-2">
                ...
                <div class="col-lg-6 text-end">
                    <button class="btnAdd bgcolor bd-full" id="btnAddProduct"><i class="fa fa-plus-circle text-color"
                                                                                 aria-hidden="true"
                                                                                 title="Thêm sản phẩm"
                                                                                 data-bs-toggle="modal"
                                                                                 data-bs-target="#addProduct"></i>
            ...
            <div class="row mt-3">
                <div class="col-lg-12 overflow-auto mheight">
                    ...
                    <table class="mb-3">
                        ...
                        <tr id="detailProductRow" data-bs-toggle="modal" data-bs-target="#detailProduct"
                            onclick="detailProduct('<%=p.getIdProduct()%>')">
                            ...
                            <td><%=nF.format(p.getPrice())%>
                            </td>
                            <td><%=p.getColor()%>
                            </td>
                            <td><%=p.getQuantityAvailable()%>
                            </td>
                            <%if (p.isStatus()) {%>
                            <td>Đang bán</td>
                            <%} else {%>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <button class="delete btnAdd bgcolor bd-full" title="Xóa" aria-hidden="true"
                                            data-bs-toggle="modal" data-bs-target=""><i
                                            class="fa fa-trash-o text-color"></i></button>
                                    <button class="editProduct btnAdd bgcolor bd-full mx-1" title="Chỉnh sửa"
                                            aria-hidden="true" data-bs-toggle="modal" data-bs-target="#editProduct"><i
                                            class="fa fa-pencil text-color"></i></button>
                                    <button class="hideProduct btnAdd bgcolor bd-full" title="Ẩn/hiện sản phẩm"
                                            aria-hidden="true" data-bs-toggle="modal" data-bs-target=""><i
                                            class="fa fa-lock text-color"></i></button>
                                </div>
                            </td>
                        </tr>
                        <%
            ...
            <div class="modal fade" id="editProduct" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content ">
                        <div class="modal-body">
                            <form class="editProduct" action="" method="post" id="edit-Product"
                                  onsubmit="return editProduct()">
                                <div class="row px-2">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Tên sản phẩm</label><span id="errNamePEdit"
                                                                                                class="text-danger"></span>
                                            <input type="text" class="form-control" id="nameProductEdit"
                                                   name="nameProductEdit">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Giá nhập (₫)</label><span id="errImpPriceEdit"
                                                                                                class="text-danger"></span>
                                            <input type="text" class="form-control" id="priceImpProductEdit"
                                                   name="priceProduct">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Giá bán (₫)</label><span id="errPriceEdit"
                                                                                               class="text-danger"></span>
                                            <input type="text" class="form-control" id="priceProductEdit"
                                                   name="delivery">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Hình ảnh</label><span id="errImg1Edit"
                                                                                            class="text-danger"></span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-4 mb-3">
                                                ...
                                                <input type="number" class="form-control" id="lengthEdit"
                                                       name="lengthEdit">
                                            </div>
                                            <div class="col-md-4 col-4 mb-3">
                                                <label class="form-label">Chiều rộng<span class="fs">(cm)</span></label>
                                                <input type="number" class="form-control" id="widthEdit"
                                                       name="widthEdit">
                                            </div>
                                            <div class="col-md-4 col-4 mb-3">
                                                <label class="form-label">Chiều cao<span class="fs">(cm)</span></label>
                                                <input type="number" class="form-control" id="heightEdit"
                                                       name="heightEdit">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4 col-4 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="materialEdit"
                                                       name="materialEdit">
                                            </div>
                                            <div class="col-md-4 col-4 mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Mô tả</label><span id="errDesEdit"
                                                                                         class="text-danger"></span>
                                            <textarea type="text" class="form-control" id="desEdit"
                                                      name="desEdit"></textarea>
                                        </div>
                                    </div>
                                    <div class="row p-0">
                                        <div class="col-md-12 p-0">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-12">
                                        <div class="row pt-2">
                                            <div class="col-md-12 col-sm-8 col-8">
                                                <img src="https://anphat.com.vn/media/product/40998_sihoo_m18_black_grey__2_.JPG"
                                                     alt=""
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="idProductdetail"
                                                   name="nameProductdetail" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Tên sản phẩm</label>
                                            <input type="text" class="form-control" id="nameProductdetail"
                                                   name="nameProductdetail" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Giá nhập (₫)</label>
                                            <input type="text" class="form-control" id="priceImpProductdetail"
                                                   name="priceImpProductdetail" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Giá bán (₫)</label>
                                            <input type="text" class="form-control" id="priceProductDetail"
                                                   name="priceProductDetail" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Thể loại</label>
                                            <input type="text" class="form-control" id="cateTypedetail"
                                                   name="cateTypedetail" readonly>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4 col-4 mb-3">
                                                <label class="form-label">Chiều dài<span class="fs">(cm)</span></label>
                                                <input type="number" class="form-control" id="lengthdetail"
                                                       name="lengthdetail" readonly>
                                            </div>
                                            <div class="col-md-4 col-4 mb-3">
                                                <label class="form-label">Chiều rộng<span class="fs">(cm)</span></label>
                                                <input type="number" class="form-control" id="widthdetail"
                                                       name="widthdetail" readonly>
                                            </div>
                                            <div class="col-md-4 col-4 mb-3">
                                                <label class="form-label">Chiều cao<span class="fs">(cm)</span></label>
                                                <input type="number" class="form-control" id="heightdetail"
                                                       name="heightdetail" readonly>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4 col-4 mb-3">
                                                <label class="form-label">Vật liệu</label>
                                                <input type="text" class="form-control" id="materialdetail"
                                                       name="materialdetail" readonly>
                                            </div>
                                            <div class="col-md-4 col-4 mb-3">
                                                <label class="form-label">Màu sắc</label>
                                                <input type="text" class="form-control" id="colordetail"
                                                       name="colordetail" readonly>
                                            </div>
                                            <div class="col-md-4 col-4 mb-3">
                                                <label class="form-label">Số lượng</label>
                                                <input type="number" class="form-control" id="quantitydetail"
                                                       name="amountdetail" readonly>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Mô tả</label>
                                                <textarea type="text" class="form-control" id="desdetail"
                                                          name="desdetail" readonly>
                                                    </textarea>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal fade" id="addProduct" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content ">
                        <div class="modal-body">
                            <form action="addProduct" method="post" id="add-product" enctype="multipart/form-data"
                                ...
                                <div class="row px-2">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Tên sản phẩm</label><span id="errNameP"
                                                                                                class="text-danger"></span>
                                            <input type="text" class="form-control" id="nameProduct" name="nameProduct">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Giá nhập (₫)</label><span id="errImpPriceAdd"
                                                                                                class="text-danger"></span>
                                            <input type="text" class="form-control" id="priceImpProductAdd"
                                                   name="priceImpProductAdd">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Giá bán (₫)</label><span id="errPriceAdd"
                                                                                               class="text-danger"></span>
                                            <input type="text" class="form-control" id="priceProductAdd"
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Mô tả</label><span id="errDes"
                                                                                         class="text-danger"></span>
                                            <textarea type="text" class="form-control" id="des" name="des"></textarea>
                                        </div>
                                        <div id="image">
                                            <label class="form-label">Hình ảnh</label><span id="errImg1"
                                                                                            class="text-danger"></span>
                                            <div class="mb-3">
                                        ...
                                        <div class="text-end mb-3">
                                            <button type="button" class="btnAdd bgcolor bd-full" id="btnAddImage"
        ...
        <div class="col-lg-9 bgcolor d-none " id="mngCate">
            <div class="row mt-2">
                ...
                <div class="col-lg-6 text-end">
                    <button class="btnAdd bgcolor bd-full" id="btnAddCate"><i class="fa fa-plus-circle text-color"
                                                                              aria-hidden="true" title="Thêm danh mục"
                                                                              data-bs-toggle="modal"
                                                                              data-bs-target="#addCate"></i></button>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-lg-12 overflow-auto mheight">
                    <table class="mb-3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex w-100 justify-content-center">
                                    <button class="delete btnAdd bgcolor bd-full me-1"><i
                                            class="fa fa-trash-o text-color" title="Xóa" aria-hidden="true"
                                            data-bs-toggle="modal" data-bs-target=""></i></button>
                                    <button class="editCate btnAdd bgcolor bd-full "><i class="fa fa-pencil text-color"
                                                                                        title="Chỉnh sửa danh mục"
                                                                                        aria-hidden="true"
                                                                                        data-bs-toggle="modal"
                                                                                        data-bs-target="#editCate"></i>
                                    </button>
                                </div>
                            </td>
                        </tr>
                        ...
                        <div class="modal-body">
                            <form class="cateEdit" id="cateEdit" action="" method="post" onsubmit="return editCate()">
                                <div class="row px-2">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Tên danh mục</label><span id="errNameCate"
                                                                                                class="text-danger"></span>
                                            <input type="text" class="form-control" id="nameCateEdit"
                                                   name="nameCateEdit">
                                        </div>
                                    </div>
                                    <div class="row p-0">
                        ...
                        <div class="modal-body">
                            <form id="add-Cate" action="" method="post" onsubmit="return addCate()">
                                <div class="row px-2">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Tên danh mục</label><span id="errNameCateAdd"
                                                                                                class="text-danger"></span>
